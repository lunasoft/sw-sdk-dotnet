...
{
    [TestClass]
    public class StampZip_Test_45
    {
        [TestMethod]
        public void StampZip_Test_45_StampZipV1()
        {
        ...
        [TestMethod]
        public void StampZip_Test_45_StampZipV1ByToken()
        {
            var build = new BuildSettings();
        ...
        [TestMethod]
        public void StampZip_Test_45_ValidateFormatToken()
        {
            var build = new BuildSettings();
            StampZip stamp = new StampZip(build.Url, build.Token + ".");
            var zipBytes = File.ReadAllBytes("Resources/cfdi40_stamp.zip");
        ...
        [TestMethod]
        public void StampZip_Test_45_ValidateEmptyToken()
        {
            var build = new BuildSettings();
        ...
        [TestMethod]
        public void StampZip_Test_45_ValidateEmptyZip()
        {
            var build = new BuildSettings();
            StampZip stamp = new StampZip(build.Url, build.Token);
