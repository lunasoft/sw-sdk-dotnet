    ...
    public class AccountUser : AccountUserService
    {
        ...
        internal override Response GetUser(AccountUserRequest bodyRequest)
        {
            ...
            try
            {
                ...
                var response = handlerCreate.GetResponse(request);
            ...
            try
            {
                ...
                switch (action)
                {
                    case AccountUserAction.Update:
                        ...
                        var responseUpdate = handler.GetResponse(request);
                    ...
                    case AccountUserAction.Delete:
                        ...
                        var responseDelete = handler.GetResponse(request);
            ...
            try
            {
                ...
                switch (filter)
                {
                    case AccountUserFilter.All:
                        ...
                        return handlerUsers.GetResponse(request);
