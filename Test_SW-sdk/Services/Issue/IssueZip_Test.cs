...
{
    [TestClass]
    public class IssueZip_Test
    {
        
        [TestMethod]
        public void IssueZipV1()
        {
        ...
        [TestMethod]
        public void IssueZipV1_ValidateFormatToken()
        {
            var build = new BuildSettings();
            IssueZip issue = new IssueZip(build.Url, build.Token + ".");
            var zipBytes = File.ReadAllBytes("Resources/fileIssue40.zip");
        ...
        [TestMethod]
        public void IssueZipV1_ValidateEmptyToken()
        {
            var build = new BuildSettings();
        ...
        [TestMethod]
        public void IssueZipV1_ValidateEmptyZip()
        {
            var build = new BuildSettings();
            IssueZip issue = new IssueZip(build.Url, build.Token);
